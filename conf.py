...
BLOG_AUTHOR = "Debra Cooperman"  # (translatable)
BLOG_TITLE = "Debra Cooperman's custom web site"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://deb-demosite.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://deb-demosite.com/"
BLOG_EMAIL = "cooperman.d@northeastern.edu"
BLOG_DESCRIPTION = "This is a site to demonstrate static web hosting on s3 using the AWS Python SDK."  # (translatable)
